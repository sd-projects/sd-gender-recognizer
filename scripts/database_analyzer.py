...
def data_analyzer(p1, p2, p3, i1):
    m_data = ["G:/ruls_data/train/audio/8086/7771/", "G:/ruls_data/train/audio/8169/12256/",
              "G:/ruls_data/test/audio/2826/2145/", "G:/ruls_data/test/audio/4471/2145/",
              "G:/ruls_data/test/audio/4372/2145/"]
    m_errs = [0 for _ in range(3)]

    f_data = ["G:/ruls_data/train/audio/9014/11018/", "G:/ruls_data/train/audio/9014/8641/",
              "G:/ruls_data/test/audio/2671/2145/", "G:/ruls_data/test/audio/3056/2145/",
              "G:/ruls_data/dev/audio/5397/2145/"]
    f_errs = [0 for _ in range(3)]

    for i in range(5):
        temp_errs = analyzer(m_data, "m", p1, p2, p3, i1, i)

        for j in range(3):
            m_errs[j] += temp_errs[j]

    for i in range(5):
        temp_errs = analyzer(f_data, "f", p1, p2, p3, i1, i)
